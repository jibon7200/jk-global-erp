...
DEFAULT_SUPERUSER_USERNAME = config('DEFAULT_SUPERUSER_USERNAME', default='')
DEFAULT_SUPERUSER_PASSWORD = config('DEFAULT_SUPERUSER_PASSWORD', default='')
DEFAULT_SUPERUSER_EMAIL = config('DEFAULT_SUPERUSER_EMAIL', default='')
